...
This deployment type is intended for fully functional Zscaler Branch Connector + integrated App Connector virtual appliance deployments in a KVM environment. This template is intended to deploy 2 VMs simultaneously in an Active/Passive HA configuration.
